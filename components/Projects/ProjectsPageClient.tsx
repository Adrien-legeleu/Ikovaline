  ...
  return (
    <section id="projects" className="mx-auto max-w-7xl px-5 pt-6">
      <header className="mb-10 text-center">
        <p className="inline-block rounded-full px-4 py-1 text-xs font-semibold tracking-wide backdrop-blur-2xl
        ...
        <p className="mt-3 text-neutral-700 dark:text-neutral-300">
          Sites premium, SaaS scalables, SEO & automation — pensés pour convertir, mesurer et scaler.
        </p>
      </header>

      <ProjectsGrid projects={PROJECTS_FR} baseHref="/projets" />
    </section>
  );
}
