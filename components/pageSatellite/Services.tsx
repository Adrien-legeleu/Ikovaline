...
type ServiceItem = { text: string; subtext: string; link: string };

type Props = {
  serviceAgenceWeb: ReadonlyArray<ServiceItem>; // ⬅️ au lieu de ServiceItem[]
};
export default function Services({ serviceAgenceWeb }: Props) {
  return (
