...
function MockStrategie() {
  return (
    <CardShell>
      ...
      <div
        className="mt-2 h-2 w-full rounded bg-neutral-100 dark:bg-neutral-800 overflow-hidden"
        aria-hidden
      >
...
function MockSEO() {
  return (
    <CardShell>
      <div
        className="h-3 w-28 rounded bg-neutral-200 dark:bg-neutral-700"
        aria-hidden
      />
      <div
        className="mt-1 h-2 w-20 rounded bg-neutral-100 dark:bg-neutral-800"
        aria-hidden
      />
      <div
        className="mt-1.5 flex items-center gap-1.5 text-[10px] text-neutral-500 dark:text-neutral-400"
        aria-hidden
      >
        #12 →{' '}
