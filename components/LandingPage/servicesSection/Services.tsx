...
export default function Services() {
  return (
    ...
    <div className="overflow-hidden relative py-5 px-2">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1/2 xs:w-2/3 h-[80%] xs:h-1/2 blur-3xl  xs:opacity-30 opacity-20  dark:opacity-15 xs:dark:opacity-20  bg-gradient-to-bl from-[#59D9F1] to-[#47EAE0] z-0"/>
