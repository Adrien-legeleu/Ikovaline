...
export default function ContactFormStudent({
  ...
  return (
    <div className="max-w-lg w-full mx-auto font-poppins  rounded-3xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <h1 className="font-extrabold max-lg:hidden text-2xl sm:text-left text-center text-neutral-800 dark:text-neutral-100">
        Rejoignez l&lsquo;aventure Ikovaline !
      </h1>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <button
          className="bg-gradient-to-br relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800 w-full text-white rounded-3xl h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
          type="submit"
        >
          Envoyer
          <BottomGradient />
