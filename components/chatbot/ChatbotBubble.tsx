              ...
              >
                ...
                <div className="flex items-center justify-between px-5 py-3 border-b border-black/5 dark:border-white/5 bg-white/60 dark:bg-neutral-950/70">
                  <div className="flex items-center gap-3">
                    <div className="relative h-10 w-10 rounded-2xl flex items-center justify-center bg-white/90 dark:bg-neutral-900/70 ring-1 ring-black/[0.02] dark:ring-white/[0.02] overflow-hidden">
                      <Image
                        src={IkovalineLogo}
                        alt="Ikovaline"
                ...
                <div className="px-5 pb-3 pt-1 flex gap-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 inline-flex items-center justify-center gap-2 rounded-[3rem] bg-primary text-white px-4 py-2.5 font-medium text-[13px] shadow-[0_8px_24px_-10px_rgba(0,0,0,0.35)] ring-1 ring-primary/40 hover:brightness-[1.05] transition"
                  >
              ...
              <DrawerFooter className="pt-2 gap-0">
                <div className="px-5 pb-3 pt-1 flex gap-2 select-none">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 inline-flex items-center justify-center gap-2 rounded-[3rem] bg-primary text-white px-4 py-2.5 text-[13px] ring-1 ring-primary/40 hover:brightness-[1.05] transition"
                  >
                    <Calendar size={14} /> RDV 30 min
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 inline-flex items-center justify-center gap-2 rounded-[3rem] bg-white/80 dark:bg-neutral-900/70 text-neutral-900 dark:text-neutral-50 px-4 py-2.5 text-[13px] ring-1 ring-black/[0.02] dark:ring-white/[0.04] hover:bg-white/90 dark:hover:bg-neutral-900/85 transition"
                  >
                    <Mail size={14} /> Nous écrire
                  </a>
                </div>
