    ...
    <section className="space-y-8 px-2">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground max-w-prose">
          Vos informations internes et la sécurité d’accès à l’espace dev.
        </p>
      </motion.div>
        ...
        >
          ...
          <div className="relative z-10 space-y-6">
            ...
            <header className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Coordonnées visibles par l’équipe projet.
                </p>
              </div>
            </header>
            ...
            <div className="rounded-[1.2rem] bg-black/[0.05] dark:bg-white/[0.07] text-[11px] leading-relaxed p-4 ring-1 ring-black/10 dark:ring-white/10 text-muted-foreground">
              Ces infos sont visibles par l’équipe projet pour vous contacter
              rapidement (technique, urgences). Mettez-les à jour si besoin.
            </div>
          </div>
        </motion.form>
          ...
          <div className="relative z-10 flex flex-col gap-6 h-full">
            <header className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Change ton mot de passe développeur.
                </p>
              </div>
            </header>
            ...
            <div className="mt-auto rounded-[1.2rem] bg-black/[0.05] dark:bg-white/[0.07] text-[11px] leading-relaxed p-4 ring-1 ring-black/10 dark:ring-white/10 text-muted-foreground">
              Utilise un mot de passe difficile à deviner. Évite de le partager,
              même dans les channels internes.
            </div>
          </div>
        </motion.form>
      </div>
...
function EditRow({
  ...
  return (
    <div className="space-y-2">
      <div className="rounded-[2rem] px-4 py-3 bg-black/[0.03] dark:bg:white/[0.06] dark:bg-white/[0.06] ring-1 ring-black/5 dark:ring-white/5 flex flex-col gap-2">
...
function StaticRow({
  ...
  return (
    <div className="space-y-2">
      <div className="rounded-[2rem] px-4 py-3 bg-black/[0.03] dark:bg:white/[0.06] dark:bg-white/[0.06] ring-1 ring-black/5 dark:ring-white/5 flex items-start gap-3 text-left">
