...
import RewardRevealDialog from '@/components/mystery-chests/RewardRevealDialog';
            ...
            >
              ...
              >
                ...
                {availableRounds > 0 && selectedChest !== index && (
                  <motion.div
                    className="absolute inset-0 rounded-3xl bg-gradient-to-br from-blue-400 to-purple-400 opacity-0"
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full">
                  {availableRounds === 0 ? (
                    ...
                    <Gift className="w-20 h-20 text-blue-500 mb-4" />
                  )}
        ...
        {availableRounds === 0 && (
          ...
          >
            <a
              ...
              className="inline-block px-8 py-3 bg-gradient-to-r from-[#ff7a00] to-[#ff3c00] text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
