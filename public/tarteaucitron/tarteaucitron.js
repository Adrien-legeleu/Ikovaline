    ...
    tarteaucitron.addInternalScript(pathToLang, "", function () {
      ...
      tarteaucitron.addInternalScript(pathToServices, "", function () {
        ...
        if (
          ...
          html += `
                      <div tabindex="-1" id="tarteaucitronAlertBig" class="tarteaucitronAlertBig${orientation}" ${modalAttrs}>
                        <div class="custom-cookie-banner">
                          <span id="tarteaucitronDisclaimerAlert" role="paragraph">
                            ${tarteaucitron.parameters.highPrivacy ? tarteaucitron.lang.alertBigPrivacy : tarteaucitron.lang.alertBigClick + " " + tarteaucitron.lang.alertBig}
                          </span>
                  
                          <div class="custom-cookie-buttons">
                            <button onclick="tarteaucitron.userInterface.respondAll(true)"> Tout accepter</button>
                            <button onclick="tarteaucitron.userInterface.openPanel()"> Personnaliser</button>
                            <button onclick="tarteaucitron.userInterface.respondAll(false)"> Tout refuser</button>
                          </div>
                  
                          ${
                            tarteaucitron.parameters.privacyUrl !== ""
                              ? `
                            <a href="${tarteaucitron.parameters.privacyUrl}" target="_blank">
